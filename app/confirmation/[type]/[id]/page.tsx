          ...
          <div className="mx-auto max-w-3xl">
            <div className="mb-8 flex flex-col items-center justify-center text-center">
              ...
              <p className="mt-2 text-muted-foreground">
                Your booking has been confirmed and your {params.type}{" "}
                {params.type === "flights" ? "ticket" : "ticket"} is ready.
              </p>
            </div>
            ...
            <Card>
                  ...
                  <ul className="space-y-2 text-sm">
                    <li>
                      ...
                      {params.type === "flights"
                        ...
                        : "terminal"}{" "}
                      at least{" "}
                      {params.type === "flights" ? "2 hours" : "30 minutes"}{" "}
                      before departure.
                    </li>
              ...
              <CardFooter className="flex flex-col gap-4 sm:flex-row">
                <Button className="w-full sm:w-auto" asChild>
                  <a
                    href={`/booking/${params.type}/${params.id}/download`}
                    download
                  >
                ...
                <Button variant="outline" className="w-full sm:w-auto" asChild>
                  <a
                    href={`/booking/${params.type}/${params.id}/print`}
                    target="_blank"
                    rel="noreferrer"
                  >
                    Print Ticket
